...
real_t forced_damped::damping = 0.0;
real_t forced_damped::force = 0.0;
...
void poincare(array_t& y, size_t niter, real_t damping, real_t force)  {
   const size_t NSTEPS = 256;
   forced_damped::damping = damping;
   forced_damped::force = force;
